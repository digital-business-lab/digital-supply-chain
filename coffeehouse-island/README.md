...
The Coffee House is the consumer endpoint of the supply chain. It is intentionally lean: no ERP system, no Kafka, no Fabric peer node. A real coffee house has no IT department. Its three software modules can run on one machine or on separate hardware.

→ [Full architecture overview](../docs/architecture.md) | [Lab Cloud](../docs/lab-cloud.md) | [Hyperledger Fabric](../docs/hyperledger-fabric.md)
...
Traceability Display queries Lab Cloud Fabric Gateway (REST)
    ↓
Display shows:
  ✓ Farm:        harvested Yirgacheffe, Ethiopia, 1850m
