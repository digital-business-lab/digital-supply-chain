...
|---|---|---|---|
| [Farm](islands/farm/index.md) | Origin of the supply chain | Coffee farm (e.g. Ethiopia / Colombia) | LoRaWAN sensors, ChirpStack, ERPNext, Fabric peer |
| [Factory](islands/factory/index.md) | Processing | Roasting & packaging | 2× Dobot robots, MES, OPC-UA, ERPNext, Fabric peer |
...
| Robot control (factory) | Dobot Python SDK / ROS2 | Factory | Pick & place, sorting, QC |
| Robot control (delivery) | ROS2 Humble + Nav2 | Distributor | Autonomous last-mile delivery (TurtleBot4 Lite) |
| ROS2–ERP bridge | rosbridge\_suite + Node-RED | Distributor | Translates ERPNext delivery orders into Nav2 navigation goals |
| Machine data | OPC-UA | Factory | Machine status to MES |
| Route planning | VROOM | Distributor | Pick-sequence and delivery route optimisation |
